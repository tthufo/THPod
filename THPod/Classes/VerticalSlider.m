...
{
    return CGRectMake(0, (self.frame.size.width - [self.thick floatValue]) / 2, self.frame.size.height, [self.thick floatValue]);
}
...
@implementation VerticalSlider (xibRunTime)

...
- (void) setupImageViewerWithDatasource:(id<MHFacebookImageViewerDatasource>)imageDatasource andInfo:(NSDictionary*)info initialIndex:(NSInteger)initialIndex onOpen:(MHFacebookImageViewerOpeningBlock)open onClose:(MHFacebookImageViewerClosingBlock)close{
    self.userInteractionEnabled = YES;
    MHFacebookImageViewerTapGestureRecognizer *  tapGesture = [[MHFacebookImageViewerTapGestureRecognizer alloc] initWithTarget:self action:@selector(didTap:)];
    tapGesture.inforDict = info;
...
- (void) didTap:(MHFacebookImageViewerTapGestureRecognizer*)gestureRecognizer {
    ...
    MHFacebookImageViewer * viewr = [[MHFacebookImageViewer alloc]init];
    viewr.information =  gestureRecognizer.inforDict; //[gestureRecognizer.accessibilityLabel objectFromJSONString];
    [self setImageBrowser:viewr];
